...
export const OFFICE_BLUE = {
  ink: "0A5FD0", // ★画面の押せる物・選ばれている物／紙はタイトルだけ★
  strong: "007AFF", // 見出し・飾り線（強め）
  bg: "F2F7FF", // 地・ヘッダー面
  line: "DBE7F7", // 罫・枠（★紙ではもう使わない＝灰にした★）
  muted: "5A6B82", // ★もう使わない（薄い灰青）★
};

// ★紙(PDF/Excel)の文字の濃さ★ 2026-08-15 指示役
//   ★全体の色から作らない。ここで固定する。★
//   会社が全体の色を変えても、本文・明細・金額は1ビットも動かない＝
//   薄い色を選ばれても「読めない請求書」が客先へ出ない。
export const PAPER_INK = {
  ink: "1A1A1A", // 本文・明細・金額・宛名・合計（画面の #333333 より濃く）
  sub: "444444", // 副（自社情報・注記・ラベル）。これより薄くしない
  rule: "999999", // 罫線＝濃さで作る（色で作らない）
  hair: "BFBFBF", // 極薄罫
};
